 ...
 *
 * Attaches session-management and messaging properties to a SessionToolContext using
 ...
 *
 * Defines lazy getters for session metadata, cross-session coordination,
 * messaging discovery/delivery, and source activation callbacks.
 *
...
export function attachSessionSelfManagementBindings(
  ...
  Object.defineProperty(context, 'listMessagingSessions', {
    get() {
      return getSessionScopedToolCallbacks(sessionId)?.listMessagingSessionsFn;
    },
    configurable: true,
    enumerable: true,
  });
