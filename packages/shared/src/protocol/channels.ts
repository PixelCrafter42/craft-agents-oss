...
export const RPC_CHANNELS = {
  ...
  messaging: {
    ...
    LARK_BEGIN_REGISTRATION: 'messaging:lark:beginRegistration',
    LARK_REGISTRATION_STATUS: 'messaging:lark:registrationStatus',
    LARK_CANCEL_REGISTRATION: 'messaging:lark:cancelRegistration',
