...
export const CHANNEL_MAP = {
  ...
  getLlmModelFallbackSettings: invoke(RPC_CHANNELS.llmConnections.GET_FALLBACK_SETTINGS),
  setLlmModelFallbackSettings: invoke(RPC_CHANNELS.llmConnections.SET_FALLBACK_SETTINGS),
  ...
  beginLarkRegistration: invoke(RPC_CHANNELS.messaging.LARK_BEGIN_REGISTRATION),
  getLarkRegistrationStatus: invoke(RPC_CHANNELS.messaging.LARK_REGISTRATION_STATUS),
  cancelLarkRegistration: invoke(RPC_CHANNELS.messaging.LARK_CANCEL_REGISTRATION),
