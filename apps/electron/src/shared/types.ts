...
export interface ElectronAPI {
  ...
  getLlmModelFallbackSettings(): Promise<LlmModelFallbackSettings>
  setLlmModelFallbackSettings(settings: LlmModelFallbackSettings): Promise<{ success: boolean; error?: string }>
