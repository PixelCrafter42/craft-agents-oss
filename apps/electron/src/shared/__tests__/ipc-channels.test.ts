...
const EXPECTED_CHANNELS: string[] = [
  ...
  'employees:updateDefinition',
  'employees:updateMemory',
  ...
  'messaging:lark:beginRegistration',
  'messaging:lark:cancelRegistration',
  'messaging:lark:registrationStatus',
  ...
  'webhooks:getListenerConfig',
  'webhooks:getListenerStatus',
  'webhooks:getTriggerSecret',
  'webhooks:rotateTriggerSecret',
  'webhooks:sendLocalTest',
  'webhooks:setListenerConfig',
  'window:cancelClose',
  'window:close',
