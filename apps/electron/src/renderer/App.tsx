...
export default function App() {
  ...
  useEffect(() => {
    ...
    const handoffEventTypes = new Set(['complete', 'error', 'interrupted', 'typed_error', 'session_status_changed', 'session_metadata_changed', 'session_flagged', 'session_unflagged', 'name_changed', 'labels_changed', 'project_id_changed', 'employee_id_changed', 'title_generated', 'async_operation'])
